...
const {adminMiddleWare, authUserMiddleWare, salesAgentMiddleWare} = require('../middleware/AuthMiddleWare')
...
router.get('/get-all-users', salesAgentMiddleWare, adminController.getAllUser)
